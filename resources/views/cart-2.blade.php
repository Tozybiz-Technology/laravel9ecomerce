...
<head>
    ...
    <!-- Title -->
    <title>Cart -Smart Africa Furniture</title>
     <!--custom css-->
    <!-- Bootstrap css -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="table_desc">
                                ...
                                @foreach( $cartitems as $cart)
                                    ...
                                    <tr>
                                        <td class="product_thumb">
                                            <a href="{{url('product-details',$cart->products->id)}}">
                                            <img src="{{ asset('images/products/' . $cart->image) }}" width="80" height="80" alt="chairs"/></a>
                                        </td>
                                        <td class="product_name">
                                            <a href="{{url('product-details',$cart->products->id)}}">{{$cart->product_title}}</a>
                                        </td>
                                        ...
                                        <td class="product_quantity">
                                            ...
                                            <!--<div class="plus-minus-input">
                                                ...
                                                <input class="form-control" type="number" name="quantity1" value="{{$cart->quantity}}">
                                                <div class="input-group-button">
                                        ...
                                        <td class="product_remove"><a href="{{url('/DeleteCart',$cart->id)}}" onclick="return confirm('Are you sure to remove this product from the cart?')" ><i class="far fa-trash-alt"></i></a></td>
                        ...
                        <div class="checkout mt-3">
                                <a href="{{ url('/checkout')}}" class="theme-btn-one btn-black-overlay btn_sm">Proceed to
                                    Checkout</a>
                            </div>
                    </div>
                </div>
                @else
                                  <div class="card">  <div class="card-body text-center">
                                        <h2 class="mb-5"> Your <i class="fa-fa-shopping-cart"></i>Cart is empty</h2>
                                        <a href="{{url('shop')}}" class="theme-btn-one btn-black-overlay btn_sm">Continue Shopping</a>
