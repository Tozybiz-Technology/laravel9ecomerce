            ...
            <div class="container">
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu">
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="furniture.html" class="nav-link">Home</a>
                            </li>
                            <li class="nav-item megamenu"><a href="shop.html" class="nav-link active">Shop </a>
                            </li>
...
@endif
   <div class=container>
   <div class="mt-3 mb-3"><a href="{{url('/')}}" class="btn btn-primary">Go to home page</a></div>
    <div class="row">
    <div class="card">
      <div class="card-body">
        <h5>You are writing a review for {{$review->product->product_name}}</h5>
