...
<body>
   ...
   <!-- <div class="search-overlay">
    ...
    <section id="shop_main_area" class="mt-3">
        <div class="container">
            <div class="row">
            @foreach($shop as $shop_product)
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="product_wrappers_one">
                        <div class="thumb">
                            <a href="{{url('product-details',$shop_product->id)}}" class="image">
                               <img src="{{ asset('images/products/' . $shop_product->image) }}" alt="Product" />
                            </a>
                            
                                                <div class="add-to-cart">
                                                    <a href="{{url('product-details',$shop_product->id)}}" title="Buy"
                                                        class="offcanvas-toggle theme-btn-one bg-gold btn_sm text-white"><i
                                                            class="fas fa-cart-arrow-down"></i>Buy</a>
                                                </div>
                        </div>
                        <div class="content">
                            <h5 class="title"><a href="product-single">{{$shop_product->product_name}}</a></h5>
                            <span class="price">
                                <span class="new">{{$shop_product->price}}</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <!-- pagination start -->
                    <ul class="pagination">
                        <li class="page-item"> {{$shop->links()}}</li>  
                    </ul>
                    <!-- pagination end -->
                </div>
            </div>
