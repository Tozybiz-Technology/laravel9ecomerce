            ...
            <ul class="navbar-nav">
              <li class="nav-item"><a href="#" class="nav-link">Home <i class='fas fa-chevron-down'></i></a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a href="index-2.html" class="nav-link">Fashion</a></li>
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="erorr_wrapper">
            ...
            <a href="index-2.html" class="theme-btn-one btn-black-overlay btn_md">Back To Home Page</a>
          </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from andit.co/projects/html/andshop/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Jan 2023 14:21:51 GMT -->
</html>