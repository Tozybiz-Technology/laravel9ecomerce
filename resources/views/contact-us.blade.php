                    ...
                    <div class="left_side_contact">
                        <ul>
                            <li class="address_location">
                                ...
                                <p>Njiapanda Segerea & Kigamboni Dar es salaam</p>
                            </li>
                            <li class="address_location">
                                <i class="fas fa-phone-volume"></i>
                                <div class="contact_widget">
                                    <a href="#!">+255 (715) 759-613</a>
                                    <a href="#!">+255 (754) 759-613</a>
                                </div>
                            </li>
                            <li class="address_location">
                                <i class="far fa-envelope"></i>
                                <div class="contact_widget">
                                    <a href="mailto:demo235@gmail.com">wllichiza@gmail.com</a>
                                    <a href="mailto:demo235@gmail.com">furnitures865@gmail.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
