...
<body>
   ...
   <!-- <div class="search-overlay">
    ...
    <section id="shop_main_area" class="mt-3">
        <div class="container">
            <div class="row">
            <h2 class="text-center mt-4 mb-4">{{$category->name}}</h2>
            @foreach($products as $prod)
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="product_wrappers_one">
                        <div class="thumb">
                            <a href="{{url('product-details',$prod->id)}}" class="image">
                               <img src="{{ asset('images/products/' . $prod->image) }}" alt="Product" />
                            </a>
                        </div>
                        <div class="content">
                            <h5 class="title"><a href="{{url('product-details',$prod->id)}}">{{$prod->product_name}}</a></h5>
                            <h5 class="title"><a href="{{url('product-details',$prod->id)}}">{{$prod->description}}</a></h5>
