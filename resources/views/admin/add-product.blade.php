            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="add_product_wrapper">
                        ...
                        <h3>Add Product</h3>
                        <form method="POST" action="{{url('insert-product')}}" class="add_product_form"  enctype="multipart/form-data">
                         @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="image-input">
                                        <img src="assets/img/furniture/banner/feature3.png" class="image-preview"
                                            alt="img">
                                ...
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        ...
                                        <select name="catname" id="category" class="form-control input-sm">
                                ...
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        ...
                                        <input type="number" id="title" name="quantity" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        ...
                                        <input type="date" id="product_available" name="available_time" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <input type="checkbox" id="mystatus" name="status">
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="checkbox" id="mostpopular" name="mostpopular">
                                    </div>
                                    <div class="col-lg-6 mb-3">
