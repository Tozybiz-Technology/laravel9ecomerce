                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="add_product_wrapper">
                        <div class="back_to_area">
                            <a href="{{url('admin.vendor')}}"><i class="fas fa-long-arrow-alt-left"></i> Back To Dashboard</a>
                        </div>
                        <h3>Update  Products</h3>
                        <form method="POST" action="/admin.product-edit" class="add_product_form"  enctype="multipart/form-data">
                         @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        ...
                                        <input type="text" id="name" name="product_name" class="form-control"  value="{{$products['product_name']}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_name">Select Product Category</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        ...
                                        <input type="text" id="slug" name="slug" class="form-control"  value="{{$products['slug']}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_price">Product Title</label>
                                        <input type="text" id="title" name="title" class="form-control"  value="{{$products['title']}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_price">Product Quantity</label>
                                        <input type="number" id="title" name="quantity" class="form-control" value="{{$products['quantity']}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_price">Small description*</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_price">Available Time</label>
                                        <input type="date" id="product_available" name="available_time" class="form-control" value="{{$products['available_time']}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        ...
                                        <input type="number" id="price" name="price" class="form-control" value="{{$products['price']}}">
                                    </div>
                                </div>
                                
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_price">Discount Price</label>
                                        <input type="number" id="discount_price" name="discount_price" class="form-control" value="{{$products['discount_price']}}">
                                    </div>
                                </div>
                                
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_price">Meta Title</label>
                                        <input type="text" id="meta_title" name="meta_title" class="form-control" value="{{$products['meta_title']}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="fotm-group">
                                        <label for="product_price">Meta Keywords</label>
                                        <textarea  name="meta_keywords" rows="3" class="form-control">{{$products->meta_keywords}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="fotm-group">
                                        <label for="product_price">Meta Description</label>
                                ...
                                <div class="col-md-12 mb-3">
                                        ...
                                        @if($products->image)
                                    <img src="{{ asset('images/products/' . $products->image) }}" width="80" height="80" alt="chair"/>
                                    @endif
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="checkbox" id="trending" name="trending" {{$products->trending == '1' ? 'checked':'' }}>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <label for="mostpopular">New Arrival</label>
                                        <input type="checkbox" id="mostpopular" name="mostpopular" {{$products->mostpopular == '1' ? 'checked':'' }}>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <label for="bestseller">Best Seller</label>
                                        <input type="checkbox" id="bestseller" name="bestseller" {{$products->bestseller == '1' ? 'checked':'' }}>
                                    </div>
                                <div class="col-lg-6 mb-3">
                                        <label for="featured">Featured</label>
                                        <input type="checkbox" id="featured" name="featured" {{$products->featured == '1' ? 'checked':'' }}>
                                    </div>
                                <div class="col-lg-12">
