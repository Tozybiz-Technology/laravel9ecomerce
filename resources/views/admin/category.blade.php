            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="add_product_wrapper">
                        ...
                        <form method="POST" action="{{url('insert-category')}}" class="add_product_form" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                        ...
                                        <textarea  name="meta_description" id="meta_decription" rows="3" class="form-control"></textarea>
                                </div>
                                <div class="col-md-12 mb-3">
