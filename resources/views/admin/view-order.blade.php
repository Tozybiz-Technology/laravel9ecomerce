...
<body>
 ...
 <div class="top-header">
   ...
   <!-- <div class="search-overlay">
    ...
    <div class="back_to_area fs-1 mr-3 fw-bold text-center mt-3">
       ...
       <div class="vendor_order_boxed">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
            <a href="{{url('order-history')}}" class="btn btn-warning float-end mb-2" >ORDER HISTORY</a>
            </div>
          </div>
            ...
            @foreach($orders as $order)
                <tr>
                    ...
                    <td><a href="{{url('orders-view/'.$order->id)}}" class="view">view</a></td>
                    <td><a href="{{url('print-pdf',$order->id)}}"  class="theme-btn-one btn-black-overlay btn_sm">Print PDF</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
