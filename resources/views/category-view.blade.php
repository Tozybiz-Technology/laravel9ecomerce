...
<body>
    ...
    <!-- Shop Main Area -->
    <section id="shop_main_area" class="mt-3">
        <div class="container">
            <div class="row">
            <h2 class="text-center mt-4 mb-4">All Categories</h2>
            @foreach($category as $cate)
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="product_wrappers_one">
                        <div class="thumb">
                            <a href="{{url('category-details/'.$cate->slug)}}" class="image">
                               <img src="{{ asset('images/category/' . $cate->image) }}" alt="Product" />
                            </a>
                        </div>
                        <div class="content">
                            <h5 class="title"><a href="{{url('category-details/'.$cate->slug)}}">{{$cate->name}}</a></h5>
                            <h5 class="title"><a href="product-single">{{$cate->description}}</a></h5>
                ...
                <div class="col-lg-12">
                 ...
                 <h2 class="text-center mb-4">Popular categories</h2>
                                ...
                                @foreach($trending as $tre_nding)
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div>
                                                <a href="{{url('category-details/'.$tre_nding->slug)}}">
                                                <img  class="img-responsive" src="{{ asset('images/category/' . $tre_nding->image) }}" />
                                                </a>
                                            </div>
                                            <div class="product_info">
                                                <h5 class="product_title mb-2"><a href="{{url('category-details/'.$tre_nding->slug)}}">{{$tre_nding->name}}</a></h5>
                                                <h5 class="title"><a href="{{url('category-details/'.$tre_nding->slug)}}">{{$tre_nding->description}}</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                    ...
                    <!-- pagination start -->
                    <ul class="pagination">
                        <li class="page-item"> {{$trending->links()}}</li>  
                    </ul>
                    <!-- pagination end -->
                </div>
</div>
